                ...
                <div class="col">
                    <div class="card mt-5">
                        <div class="card-header">
                            <div class="card-body">
                                <h1 style="text-align: center;">Complaint List <p style="font-size: 25px;">(Latest Order)</p></h1>
                                ...
                                <form method="POST" action="filter-all.php">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    if (isset($_POST['filter'])) {
                                        ...
                                        $filter_q = "SELECT * FROM computer_forms";

                                        // If the filter is set to "latest", modify the query to only select the latest complaints
                                        if ($filter = "latest") {
                                            $filter_q = "SELECT * FROM computer_forms ORDER BY Q5 DESC";
                                        }
                                        // Execute the query and store the result
                                        $filter_query = mysqli_query($connection, $filter_q);

                                        // Loop through the result and output the complaints
